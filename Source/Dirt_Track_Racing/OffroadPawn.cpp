//This file is the set up for the blueprint of the vehicle to allow it to function
...
AOffroadPawn::AOffroadPawn()
{
	...
	/*
	This section all pulls from the ChaosVehicleMovementComponent and sets the basic functions for the wheels, engine, diff, and steering.
	...
	*/
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UOffroadFWs::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UOffroadFWs::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UOffroadRWs::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UOffroadRWs::StaticClass();
